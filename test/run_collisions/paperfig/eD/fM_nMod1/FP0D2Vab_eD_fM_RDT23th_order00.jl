...
#                                 ## ------------------------------------------------------------------------------------------------------------------------
orderRK, rsRK, iterRK = 2, 2, 10                 # [:Euler(1,:,N), :Trapz(2,:,N⁺), :RadauI3(3,2,N), :GL4(4,2,N), :LobattoIIIA4(4,3,N), :LobattoIIIA6(6,4,N), ⋯]
...
################################# For timestep
Nτ_fix = 8 * 2^1               # (=20, default) Number of timestep during one characteristic time `τ₀`
if is_MultiCase
