...
is_nai_const = false          # (=false, default),
...
if is_nai_const
    ...
    NK = 2                        # (≤ 4, now) Number of King function 
...
Te1, Te2, Tp0, TD0, TT0, Tα0  = 1.0, 10.0, 1.0, 10.0, 14.0, 1000.0
