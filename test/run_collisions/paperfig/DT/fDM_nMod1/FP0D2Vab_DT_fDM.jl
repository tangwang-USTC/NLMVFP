...
path_paper = "test/run_collisions/paperfig/DT/fDM_nMod1"
...
rtol_DnIK = 0.1                # (=0.02, default) For the minimum timestep according to `abs(dt * Rc / Mc) ≤ rtol_DnIK`
...
Nstep_max = 3                # (=10000, default) The maximum timestep
...
if NuCase ≠ 0
    ...
    EkD0, EkT0 = Ekns2[NuCase,1], Ekns2[NuCase,2]
end

# # # # The main error sources of the algorithm
is_IJ_bc = false                     # (=false, default) It will be important when the disperity of mass, temperature or the average velocity are so big.
