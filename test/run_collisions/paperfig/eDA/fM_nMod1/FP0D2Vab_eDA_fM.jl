...
path_paper = "test/run_collisions/paperfig/eDA/fM_nMod1"
...
is_dt_tau = false               # (=false, default), Whether let the timestep can be decided by `tau`
if is_sol_fvLc
    rtol_vGdom = 0.001
end
dt_initial_min = 1e-0
...
Te1, Te2, Tp0, TD0, TT0, Tα0  = 1.0, 10.0, 1.0, 1.0, 10.0, 1750.0
...
is_extrapolate_FLn = false           # (=false, default), `nnv` almost couldn't to make up the deficiency of it's vacancy.
