...
if isfile(file_Ms_Cerror)
    ...
    ppena = plot(tplot[tvec],a,line=(wline,:auto),label=label,
    ...
    ppenb = plot!(tplot[tvec],b,line=(wline,:auto),label=label)
    if ns ≥ 3
    ...
    ppeIha = plot(tplot[tvec],a,line=(wline,:auto),label=label,
                      ylabel=ylabel,yscale=:log10)
    ...
    ppeIhb = plot!(tplot[tvec],b,line=(wline,:auto),label=label)
    if ns ≥ 3
    ...
    ppeKha = plot(tplot[tvec],a,line=(wline,:auto),label=label,
                 ylabel=ylabel,yscale=:log10,
                 xlabel="t")
    ...
    ppeKhb = plot!(tplot[tvec],b,line=(wline,:auto),label=label)
    if ns ≥ 3
    ...
    ppeKa = plot(tplot[tvec],a,line=(wline,:auto),label=label,
                     ylabel=ylabel,yscale=:log10,
                     xlabel=title_model)
    ...
    ppeKb = plot!(tplot[tvec],b,line=(wline,:auto),label=label)
    if ns ≥ 3
    ...
    ppeTa = plot(tplot[tvec],a,line=(wline,:auto),label=label,
                ylabel=ylabel,
                xlabel="t")
    ...
    ppeTb = plot!(tplot[tvec],b,line=(wline,:auto),label=label)
    if ns ≥ 3
