            ...
            if is_MjMs_max
                if norm(ua[isp33]) ≤ epsT10
                    ...
                    elseif nnjM == 6
                        ...
                        is_a09, a = is_abnormal_abs(RDMck1at.Mhc4[tvec],scalea09)
                        pMhca = plot(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"a_4",ylabel=ylabel,yscale=yscale0)

                        is_a09, a = is_abnormal_abs(RDMck1at.Mhc6[tvec],scalea09)
                        pMhca = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"a_6")

                        is_a09, a = is_abnormal_abs(RDMck1at.Mhc8[tvec],scalea09)
                        pMhca = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"a_8")

                        is_a09, a = is_abnormal_abs(RDMck1at.Mhc10[tvec],scalea09)
                        pMhca = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"a_{10}")
                    elseif nnjM == 7
                        # pMhca = plot(tplot[tvec],abs.(RDMck1at.Mhc2[tvec]).+epsT,line=(wline,:auto),label=L"a_2",ylabel=ylabel,yscale=yscale0)
                        pMhca = plot(tplot[tvec],abs.(RDMck1at.Mhc4[tvec]).+epsT,line=(wline,:auto),label=L"a_4",ylabel=ylabel,yscale=yscale0)
                        pMhca = plot!(tplot[tvec],abs.(RDMck1at.Mhc6[tvec]).+epsT,line=(wline,:auto),label=L"a_6")
        ...
        if 1 == 1
            ...
            if is_MjMs_max
                if norm(ua[isp33]) ≤ epsT10
                    ...
                    elseif nnjM == 5
                        # pMhcb = plot(tplot[tvec],abs.(RDMck1bt.Mhc2[tvec]).+epsT,line=(wline,:auto),label=L"b_2",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)
                        pMhcb = plot(tplot[tvec],abs.(RDMck1bt.Mhc4[tvec]).ds+epsT,line=(wline,:auto),label=L"b_4",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)
                        pMhcb = plot!(tplot[tvec],abs.(RDMck1bt.Mhc6[tvec]).+epsT,line=(wline,:auto),label=L"b_6")
                        pMhcb = plot!(tplot[tvec],abs.(RDMck1bt.Mhc8[tvec]).+epsT,line=(wline,:auto),label=L"b_8")
                    elseif nnjM == 6
                        # pMhcb = plot(tplot[tvec],abs.(RDMck1bt.Mhc2[tvec]).+epsT,line=(wline,:auto),label=L"b_2",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)

                        is_a09, a = is_abnormal_abs(RDMck1bt.Mhc4[tvec],scalea09)
                        pMhcb = plot(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"b_4",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)

                        is_a09, a = is_abnormal_abs(RDMck1bt.Mhc6[tvec],scalea09)
                        pMhcb = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"b_6")

                        is_a09, a = is_abnormal_abs(RDMck1bt.Mhc8[tvec],scalea09)
                        pMhcb = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"b_8")

                        is_a09, a = is_abnormal_abs(RDMck1bt.Mhc10[tvec],scalea09)
                        pMhcb = plot!(tplot[tvec][is_a09],a[is_a09],line=(wline,:auto),label=L"b_{10}")
                    elseif nnjM == 7
                        # pMhcb = plot(tplot[tvec],abs.(RDMck1bt.Mhc2[tvec]).+epsT,line=(wline,:auto),label=L"b_2",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)
                        pMhcb = plot(tplot[tvec],abs.(RDMck1bt.Mhc4[tvec]).+epsT,line=(wline,:auto),label=L"b_4",ylabel=ylabel,yscale=yscale0,xlabel=xlabel)
                        pMhcb = plot!(tplot[tvec],abs.(RDMck1bt.Mhc6[tvec]).+epsT,line=(wline,:auto),label=L"b_6")
