...
path_paper = "test/run_collisions/paperfig/ee/fM_nModn"
...
if is_MultiCase
    ...
    nnv0 = 8                    # [5,  6,  7,   8,   9,   10]
    ocp0 = 8                    # (default: = 8), the order of Chebyshev polynomials on the subdivision for Gaussian-type quadrature, i.e. Clenshaw-Curtis quadrature.
end
