...
"""
  ...
  Inputs:
    XvL: XvL[1:2,:], X ∈ [f,H,G,df,ddf,dH,dG,ddG]
    uabi: [uai, ubi]
      uai = uai[isp] / vth[isp]
      ubi = uai[iFv] / vth[iFv]

  Outputs:
    Sf1 = dtfvLDMabv0(Sf1,mu,Mun,Mun1,Mun2,CH,CG,nabi,vabthi,uabi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,Mun,CH,CG,nabi,vabthi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,mu,Mun,Mun1,Mun2,CH,CG,uabi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,Mun,CH,CG,LM1)
    Sf1 = dtfvLDMabv0(Sf1,mu,Mun,Mun1,Mun2,CG,nabi,vabthi,uabi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,Mun,CG,nabi,vabthi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,mu,Mun,Mun1,Mun2,CG,uabi,LM1)
    Sf1 = dtfvLDMabv0(Sf1,Mun,CG,LM1)
"""
...
function dtfvLDMabv0(Sf1::AbstractArray{T,N},mu::AbstractArray{T,N},
    ...
    CH::T,CG::T,nabi::AbstractVector{T},vabthi::AbstractVector{T},
    ...
    if uai == 0
        ...
        if ubi == 0
            ...
            # ############ 3,  Sf3
            if CH ≠ 0.0
                Sf1 += CH * (fvLv[:,2:end] * Mun1) .* (HvLv[:,2:end] * Mun1)
            end
            ############ SG = S5 + S6 + S7 + S8 + S9 + S10 = CG * ∇∇f : ∇∇G
            # ############ 5,  Sf6
...
# uai = ubi = 0
function dtfvLDMabv0(Sf1::AbstractArray{T,N},Mun::AbstractArray{T,N},
    CH::T,CG::T,nabi::AbstractVector{T},vabthi::AbstractVector{T},LM1::Int) where{T,N}
...
function dtfvLDMabv0(Sf1::AbstractArray{T,N},mu::AbstractArray{T,N},
    Mun::AbstractArray{T,N},Mun1::AbstractArray{T,NM1},Mun2::AbstractArray{T,NM2},
    CH::T,CG::T,uabi::AbstractVector{T},LM1::Int) where{T,N,NM1,NM2}
...
# uai = ubi = 0
function dtfvLDMabv0(Sf1::AbstractArray{T,N},Mun::AbstractArray{T,N},CH::T,CG::T,LM1::Int) where{T,N}
...
function dtfvLDMabv0(Sf1::AbstractArray{T,N},mu::AbstractArray{T,N},Mun::AbstractArray{T,N},
...
function dtfvLDMabv0(Sf1::AbstractArray{T,N},mu::AbstractArray{T,N},Mun::AbstractArray{T,N},
    Mun1::AbstractArray{T,NM1},Mun2::AbstractArray{T,NM2},
    CG::T,uabi::AbstractVector{T},LM1::Int) where{T,N,NM1,NM2}
...
# uai = ubi = 0
function dtfvLDMabv0(Sf1::AbstractArray{T,N},Mun::AbstractArray{T,N},CG::T,LM1::Int) where{T,N}
